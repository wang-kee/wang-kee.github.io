...
My research interests are centered around model post-training topics such as model merging, model editing, and model fine-tuning. You can check out my research from my [Scholar page](https://scholar.google.com/citations?user=wKBORzsAAAAJ&hl=en). 

Before starting my PhD, I completed my MSc from [EPFL](https://www.epfl.ch/en/), and my BSc from [University of Electronic Science and Technology of China](https://en.uestc.edu.cn/). 
